<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <h3>{{ test }}</h3>
    <p><slot>Default content inside this HelloWorld Component</slot></p>
    <p><slot name="named_slot1">Default Named_Slot1</slot></p>
    <p><slot name="named_slot2">Default Named_Slot2</slot></p>
